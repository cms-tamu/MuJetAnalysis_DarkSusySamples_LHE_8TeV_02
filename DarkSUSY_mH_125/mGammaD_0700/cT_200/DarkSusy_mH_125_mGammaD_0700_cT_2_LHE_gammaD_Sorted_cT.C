...
//=========  (Mon Mar 16 16:50:18 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.09285854,10.375,0.6214379);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5714372);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3173434);
   h_gammaD_1_cT->SetBinContent(2,0.1184934);
   h_gammaD_1_cT->SetBinContent(3,0.04279855);
   h_gammaD_1_cT->SetBinContent(4,0.01574669);
   h_gammaD_1_cT->SetBinContent(5,0.005617978);
   h_gammaD_1_cT->SetBinContent(6,0.003283969);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3174651);
   h_gammaD_2_cT->SetBinContent(2,0.1167466);
   h_gammaD_2_cT->SetBinContent(3,0.04353379);
   h_gammaD_2_cT->SetBinContent(4,0.01586193);
   h_gammaD_2_cT->SetBinContent(5,0.006392591);
   h_gammaD_2_cT->SetBinContent(6,0.003347301);
