...
//=========  (Mon Mar 16 16:50:13 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.53125,-0.3713261,2.59375,2.485029);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.285084);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.277183);
   h_gammaD_1_cT->SetBinContent(2,0.4651947);
   h_gammaD_1_cT->SetBinContent(3,0.1705647);
   h_gammaD_1_cT->SetBinContent(4,0.06278794);
   h_gammaD_1_cT->SetBinContent(5,0.02426928);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.269491);
   h_gammaD_2_cT->SetBinContent(2,0.4699993);
   h_gammaD_2_cT->SetBinContent(3,0.1758283);
   h_gammaD_2_cT->SetBinContent(4,0.06254245);
   h_gammaD_2_cT->SetBinContent(5,0.02213892);
   h_gammaD_2_cT->SetBinContent(6,0.01260409);
