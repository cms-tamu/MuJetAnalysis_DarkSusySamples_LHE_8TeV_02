...
//=========  (Mon Mar 16 16:50:26 2015) by ROOT version5.34/18
   ...
   cnv->Range(-5.3125,-0.03730336,25.9375,0.2496456);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2295592);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1276351);
   h_gammaD_1_cT->SetBinContent(2,0.04648254);
   h_gammaD_1_cT->SetBinContent(3,0.01716263);
   h_gammaD_1_cT->SetBinContent(4,0.006351683);
   h_gammaD_1_cT->SetBinContent(5,0.00236804);
   h_gammaD_1_cT->SetBinContent(6,0.001318654);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1275329);
   h_gammaD_2_cT->SetBinContent(2,0.04639527);
   h_gammaD_2_cT->SetBinContent(3,0.01721764);
   h_gammaD_2_cT->SetBinContent(4,0.006430504);
   h_gammaD_2_cT->SetBinContent(5,0.002423709);
   h_gammaD_2_cT->SetBinContent(6,0.001343988);
