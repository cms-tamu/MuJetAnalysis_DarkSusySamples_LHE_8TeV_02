...
//=========  (Mon Mar 16 16:50:07 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.2125,-0.9281639,1.0375,6.211558);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.711778);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.181664);
   h_gammaD_1_cT->SetBinContent(2,1.169412);
   h_gammaD_1_cT->SetBinContent(3,0.4273698);
   h_gammaD_1_cT->SetBinContent(4,0.1634431);
   h_gammaD_1_cT->SetBinContent(5,0.05811172);
   h_gammaD_1_cT->SetBinContent(6,0.03670545);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.17321);
   h_gammaD_2_cT->SetBinContent(2,1.189065);
   h_gammaD_2_cT->SetBinContent(3,0.4211652);
   h_gammaD_2_cT->SetBinContent(4,0.1567887);
   h_gammaD_2_cT->SetBinContent(5,0.05977098);
   h_gammaD_2_cT->SetBinContent(6,0.033283);
