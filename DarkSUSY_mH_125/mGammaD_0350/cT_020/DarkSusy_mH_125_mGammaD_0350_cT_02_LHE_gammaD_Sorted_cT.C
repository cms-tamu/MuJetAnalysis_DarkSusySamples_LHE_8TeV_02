...
//=========  (Mon Mar 16 16:40:22 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.2125,-0.9286683,1.0375,6.214935);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.714882);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.183249);
   h_gammaD_1_cT->SetBinContent(2,1.169314);
   h_gammaD_1_cT->SetBinContent(3,0.4279744);
   h_gammaD_1_cT->SetBinContent(4,0.1601757);
   h_gammaD_1_cT->SetBinContent(5,0.05928705);
   h_gammaD_1_cT->SetBinContent(6,0.03493027);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.174935);
   h_gammaD_2_cT->SetBinContent(2,1.174092);
   h_gammaD_2_cT->SetBinContent(3,0.4321795);
   h_gammaD_2_cT->SetBinContent(4,0.1606837);
   h_gammaD_2_cT->SetBinContent(5,0.05811029);
   h_gammaD_2_cT->SetBinContent(6,0.03113051);
