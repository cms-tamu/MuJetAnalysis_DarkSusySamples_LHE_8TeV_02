...
//=========  (Mon Mar 16 16:40:18 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.53125,-0.3710918,2.59375,2.483461);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.283642);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.27151);
   h_gammaD_1_cT->SetBinContent(2,0.4720639);
   h_gammaD_1_cT->SetBinContent(3,0.1718563);
   h_gammaD_1_cT->SetBinContent(4,0.06220042);
   h_gammaD_1_cT->SetBinContent(5,0.022369);
   h_gammaD_1_cT->SetBinContent(6,0.01293326);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.26869);
   h_gammaD_2_cT->SetBinContent(2,0.4733324);
   h_gammaD_2_cT->SetBinContent(3,0.170441);
   h_gammaD_2_cT->SetBinContent(4,0.06296497);
   h_gammaD_2_cT->SetBinContent(5,0.02457169);
   h_gammaD_2_cT->SetBinContent(6,0.01404816);
