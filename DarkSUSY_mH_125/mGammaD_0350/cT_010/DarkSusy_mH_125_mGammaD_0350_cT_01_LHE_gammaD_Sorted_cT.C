...
//=========  (Mon Mar 16 16:40:15 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.10625,-1.859621,0.51875,12.44516);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.44382);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.401893);
   h_gammaD_1_cT->SetBinContent(2,2.307305);
   h_gammaD_1_cT->SetBinContent(3,0.8575133);
   h_gammaD_1_cT->SetBinContent(4,0.3154622);
   h_gammaD_1_cT->SetBinContent(5,0.1178263);
   h_gammaD_1_cT->SetBinContent(6,0.07049434);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.35768);
   h_gammaD_2_cT->SetBinContent(2,2.363616);
   h_gammaD_2_cT->SetBinContent(3,0.842325);
   h_gammaD_2_cT->SetBinContent(4,0.3205563);
   h_gammaD_2_cT->SetBinContent(5,0.1158228);
   h_gammaD_2_cT->SetBinContent(6,0.06048945);
