...
//=========  (Mon Mar 16 16:41:02 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.053125,-3.727719,0.259375,24.94704);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.93981);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.84064);
   h_gammaD_1_cT->SetBinContent(2,4.613235);
   h_gammaD_1_cT->SetBinContent(3,1.693559);
   h_gammaD_1_cT->SetBinContent(4,0.6192262);
   h_gammaD_1_cT->SetBinContent(5,0.2333426);
   h_gammaD_1_cT->SetBinContent(6,0.1371863);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.74434);
   h_gammaD_2_cT->SetBinContent(2,4.709109);
   h_gammaD_2_cT->SetBinContent(3,1.689482);
   h_gammaD_2_cT->SetBinContent(4,0.6165073);
   h_gammaD_2_cT->SetBinContent(5,0.2405637);
   h_gammaD_2_cT->SetBinContent(6,0.1305989);
