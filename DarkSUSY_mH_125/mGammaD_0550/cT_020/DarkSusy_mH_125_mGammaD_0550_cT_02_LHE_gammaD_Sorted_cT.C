...
//=========  (Mon Mar 16 16:49:28 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.2125,-0.9271333,1.0375,6.204662);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.705436);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.187252);
   h_gammaD_1_cT->SetBinContent(2,1.15991);
   h_gammaD_1_cT->SetBinContent(3,0.432898);
   h_gammaD_1_cT->SetBinContent(4,0.1625019);
   h_gammaD_1_cT->SetBinContent(5,0.05743872);
   h_gammaD_1_cT->SetBinContent(6,0.03290302);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.169687);
   h_gammaD_2_cT->SetBinContent(2,1.187995);
   h_gammaD_2_cT->SetBinContent(3,0.4261986);
   h_gammaD_2_cT->SetBinContent(4,0.1587391);
   h_gammaD_2_cT->SetBinContent(5,0.05738014);
