...
//=========  (Mon Mar 16 16:49:12 2015) by ROOT version5.34/18
   ...
   cnv->Range(-5.3125,-0.03732257,25.9375,0.2497741);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2296773);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1278613);
   h_gammaD_1_cT->SetBinContent(2,0.04680964);
   h_gammaD_1_cT->SetBinContent(3,0.01671827);
   h_gammaD_1_cT->SetBinContent(4,0.006269979);
   h_gammaD_1_cT->SetBinContent(5,0.002340859);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1275985);
   h_gammaD_2_cT->SetBinContent(2,0.04660492);
   h_gammaD_2_cT->SetBinContent(3,0.01734031);
   h_gammaD_2_cT->SetBinContent(4,0.006173554);
   h_gammaD_2_cT->SetBinContent(5,0.00228268);
   h_gammaD_2_cT->SetBinContent(6,0.001336387);
