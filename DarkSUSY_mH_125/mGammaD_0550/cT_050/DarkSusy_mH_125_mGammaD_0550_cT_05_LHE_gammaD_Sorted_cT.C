...
//=========  (Mon Mar 16 16:49:25 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.53125,-0.3723644,2.59375,2.491977);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.291473);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.272171);
   h_gammaD_1_cT->SetBinContent(2,0.4688801);
   h_gammaD_1_cT->SetBinContent(3,0.1737479);
   h_gammaD_1_cT->SetBinContent(4,0.06127096);
   h_gammaD_1_cT->SetBinContent(5,0.02392965);
   h_gammaD_1_cT->SetBinContent(6,0.01298391);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.273041);
   h_gammaD_2_cT->SetBinContent(2,0.4702565);
   h_gammaD_2_cT->SetBinContent(3,0.1712862);
   h_gammaD_2_cT->SetBinContent(4,0.06260856);
   h_gammaD_2_cT->SetBinContent(5,0.02280794);
   h_gammaD_2_cT->SetBinContent(6,0.01392141);
