...
//=========  (Mon Mar 16 16:49:30 2015) by ROOT version5.34/18
   ...
   cnv->Range(-2.125,-0.09292566,10.375,0.6218871);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5718502);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3190896);
   h_gammaD_1_cT->SetBinContent(2,0.1173957);
   h_gammaD_1_cT->SetBinContent(3,0.04218998);
   h_gammaD_1_cT->SetBinContent(4,0.01554831);
   h_gammaD_1_cT->SetBinContent(5,0.005776346);
   h_gammaD_1_cT->SetBinContent(6,0.003378974);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3176946);
   h_gammaD_2_cT->SetBinContent(2,0.1167812);
   h_gammaD_2_cT->SetBinContent(3,0.04362623);
   h_gammaD_2_cT->SetBinContent(4,0.01610428);
   h_gammaD_2_cT->SetBinContent(5,0.005793765);
   h_gammaD_2_cT->SetBinContent(6,0.003252309);
