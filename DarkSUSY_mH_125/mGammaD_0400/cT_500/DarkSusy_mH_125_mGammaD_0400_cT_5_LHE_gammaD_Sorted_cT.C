...
//=========  (Mon Mar 16 16:42:30 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.03727131,25.9375,0.2494311);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2293619);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1275189);
   h_gammaD_1_cT->SetBinContent(2,0.04660705);
   h_gammaD_1_cT->SetBinContent(3,0.01712091);
   h_gammaD_1_cT->SetBinContent(4,0.006460957);
   h_gammaD_1_cT->SetBinContent(5,0.002292191);
   h_gammaD_1_cT->SetBinContent(6,0.001508816);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1274233);
   h_gammaD_2_cT->SetBinContent(2,0.04679705);
   h_gammaD_2_cT->SetBinContent(3,0.01699262);
   h_gammaD_2_cT->SetBinContent(4,0.00655944);
   h_gammaD_2_cT->SetBinContent(5,0.002227592);
