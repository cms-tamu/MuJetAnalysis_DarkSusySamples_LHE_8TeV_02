...
//=========  (Mon Mar 16 16:42:26 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.2125,-0.9299789,1.0375,6.223705);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.722947);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.183425);
   h_gammaD_1_cT->SetBinContent(2,1.166086);
   h_gammaD_1_cT->SetBinContent(3,0.4359452);
   h_gammaD_1_cT->SetBinContent(4,0.1557801);
   h_gammaD_1_cT->SetBinContent(5,0.05876357);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.179415);
   h_gammaD_2_cT->SetBinContent(2,1.1682);
   h_gammaD_2_cT->SetBinContent(3,0.4371468);
   h_gammaD_2_cT->SetBinContent(4,0.15696);
   h_gammaD_2_cT->SetBinContent(5,0.05827785);
   h_gammaD_2_cT->SetBinContent(6,0.03474014);
