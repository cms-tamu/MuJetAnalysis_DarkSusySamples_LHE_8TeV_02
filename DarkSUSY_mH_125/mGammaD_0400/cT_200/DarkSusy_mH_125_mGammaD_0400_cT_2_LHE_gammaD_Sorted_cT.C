...
//=========  (Mon Mar 16 16:43:12 2015) by ROOT version5.34/18
   ...
   cnv->Range(-2.125,-0.09319786,10.375,0.6237088);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5735253);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3172009);
   h_gammaD_1_cT->SetBinContent(2,0.1184184);
   h_gammaD_1_cT->SetBinContent(3,0.04249238);
   h_gammaD_1_cT->SetBinContent(4,0.01587012);
   h_gammaD_1_cT->SetBinContent(5,0.00601818);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3186252);
   h_gammaD_2_cT->SetBinContent(2,0.1178877);
   h_gammaD_2_cT->SetBinContent(3,0.04261424);
   h_gammaD_2_cT->SetBinContent(4,0.01544861);
   h_gammaD_2_cT->SetBinContent(5,0.005424317);
