...
//=========  (Mon Mar 16 16:42:30 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.53125,-0.3722051,2.59375,2.490911);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.290493);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.276281);
   h_gammaD_1_cT->SetBinContent(2,0.4657748);
   h_gammaD_1_cT->SetBinContent(3,0.1717867);
   h_gammaD_1_cT->SetBinContent(4,0.06352962);
   h_gammaD_1_cT->SetBinContent(5,0.02262802);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.272496);
   h_gammaD_2_cT->SetBinContent(2,0.4684342);
   h_gammaD_2_cT->SetBinContent(3,0.1729983);
   h_gammaD_2_cT->SetBinContent(4,0.06211227);
   h_gammaD_2_cT->SetBinContent(5,0.02395903);
